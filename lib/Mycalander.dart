...
class Mycalander extends StatefulWidget {
  const Mycalander({super.key, required String title});
...
class _MycalanderState extends State<Mycalander> {
  ...
  List<DateTime?> _multiDatePickerValueWithDefaultValue = [
    DateTime(DateTime.thursday, DateTime.thursday, 1),
    DateTime(DateTime.thursday, DateTime.thursday, 5),
    DateTime(DateTime.thursday, DateTime.thursday, 14),
    DateTime(DateTime.thursday, DateTime.thursday, 17),
    DateTime(DateTime.thursday, DateTime.thursday, 25),
  ];
